...
# ---------------------------------------------------------------- services
services:
  - name: orders-svc             # addressed as http://127.0.0.1:15001/orders-svc/...
    instances:
...
| `services[].instances` | []host:port | — | yes | required, ≥ 1, unique within service |
...
4. Every instance address parses with `net.SplitHostPort`, and the port is 1..65535.
